__about__: dict = {"Exploit_Title": "vsftpd 2.3.4 - Backdoor Command Execution",
                   "Date": "9-04-2021",
                   "Version": "MS17-010 Windows 2000",
                   "Tested_on": '''Windows 2016 x64, Windows 10 Pro Build 10240 x64, Windows 2012 R2 x64, Windows 8.1 
                       x64, Windows 2008 R2 SP1 x64, Windows 7 SP1 x64, Windows 2008 SP1 x64, Windows 2003 R2 SP2 x64, 
                       Windows XP SP2 x64, Windows 8.1 x86, Windows 7 SP1 x86, Windows 2008 SP1 x86, Windows 2003 SP2 
...
def main(host: str = ""):
    target = host
    pipe_name = "attack_engine/utils/sc_x64.bin" # used project relative path for better accessibility from main files
